...
@dag(
    ...
    default_args={
        # This defines the value of the "owner" column in the DAG view of the Airflow UI
        "owner": "community",
        "retries": 4,  # If a task fails, it will retry 1 time.
...
def example_dag_advanced():
    ...
    check_day_of_week = BranchDayOfWeekOperator(
        ...
        # If True, uses task’s execution day to compare with is_today
